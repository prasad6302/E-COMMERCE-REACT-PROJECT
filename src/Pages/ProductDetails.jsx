    ...
    <>
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-10 flex flex-col md-flex-row lg:flex-row items-center gap-10">
        ...
        <div className="w-full flex justify-center lg:w-1/2 ">
          <img
            className="obtain-contain mr-10 max-h-[400px] w-full"
            src={productInfo.imgUrl}
            alt={productInfo.productName}
          />
        </div>
        <div className="w-full lg:w-1/2 py- space-y-5">
          ...
          <div className="flex items-center gap-15">
            ...
            <p className="text-gray-700  text-xl">category: <span className="font-bold">{productInfo.category}</span></p>
          </div>
          ...
          <div className="">
            <input
              type="number"
              defaultValue={1}
              className="w-20 flex gap-4 mb-4 h-10 border border-gray-400 rounded text-center" />
            <button className="bg-blue-900 px-6 py-2 h-12 w-40 text-white rounded hover:bg-blue-800 ">
              Add To Cart
            </button>
          </div>
        </div>
