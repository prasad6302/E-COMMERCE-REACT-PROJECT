      ...
      <div className="flex-1 space-y-6 max-w-full xl:max-w-[950px] 2xl:max-w-[1100px] mx-auto">
        {cartItems.length === 0 ? (
          ...
          cartItems.map((item) => (
            <div
              key={item.id}
              className="bg-white rounded-xl shadow-md p-4 sm:p-6 flex flex-col sm:flex-row items-center sm:justify-between relative gap-6"
            >
              {/* Remove Button */}
              <button
              ...
              {/* Image */}
              <div className="w-28 h-28 sm:w-32 sm:h-32 xl:w-40 xl:h-40 2xl:w-52 2xl:h-52 flex-shrink-0">
                <img
                  src={item.imgUrl}
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-blue-800 font-bold text-md mt-1">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="bg-white border border-gray-300 p-2 rounded hover:bg-blue-600 hover:text-white transition"
                >
                  <FaPlus />
                </button>
                <button
